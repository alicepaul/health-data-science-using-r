...
The `summary()` and `table()` functions allow us to summarize the univariate sample distributions of columns. We may also want to plot these distributions. We saw in the [last chapter](https://alicepaul.github.io/health-data-science-in-r/book/3_data_files.html) that the `hist()` function creates a histogram plot. Below we use this function to plot a histogram of the log transformation of the lead column.
...
<img src="images/4-exercise4plot1.png" alt= “” width="250pt" align="left">
<img src="images/4-exercise4plot2.png" alt= “” width="250pt" align="left">
