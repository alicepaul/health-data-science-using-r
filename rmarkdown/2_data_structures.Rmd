...
1. Recreate the following data frame in R, where `temperature` and `co2` represent the average temperature in Farenheit and the average $\text{CO}_2$ concentrations in $\text{mg}/\text{m}^3$ for the month of January 2008, and name it `city_air_quality`. 
