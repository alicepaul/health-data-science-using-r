...
The following exercises use the `covidcases` dataset from the `RforHDSdata` package. Before completing the exercises, be sure to read the documentation for this data (`?covidcases`).
...
covidcases %>% ungroup() %>%
  ...
  slice_min(order_by = weekly_deaths, n=10, with_ties = FALSE)
```
