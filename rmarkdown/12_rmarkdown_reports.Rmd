---
title: An R Markdown document converted from "./book/12_rmarkdown_reports.ipynb"
output: html_document
---

# 12. Writing Reports in R Markdown
...
Here is some other LaTeX notation that you should know in order to write common equations:
