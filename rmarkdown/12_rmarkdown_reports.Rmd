...
An alternative to creating tables with `kableExtra` is to use the `gt` and `gtsummary` packages that were described in [Chapter 4](https://alicepaul.github.io/r-for-health-data-science/book/4_exploratory_analysis.html). For example, the following chunk would create the nice table below once the .Rmd document is knitted to a pdf.


<img src="images/12-gttableexample.png" alt= “” width="500pt" align="center">
