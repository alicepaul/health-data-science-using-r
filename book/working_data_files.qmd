...
Earlier, we created a column indicating whether or not a patient has lower back pain. We now use the `|` operator and the `pmax()` function to check whether a patient has general back pain. If at least one of the back region areas has value 1, then either of these approaches will return `TRUE`.  

```{r}
pain$BACK <- pmax(pain$X208, pain$X209, pain$X212, 
                 pain$X213, pain$X218, pain$X219) == 1
pain$BACK <- (pain$X208==1) | (pain$X209==1) | (pain$X212==1) |
