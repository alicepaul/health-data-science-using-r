...
In this chapter and all future chapters, we load in the required libraries at the start of the chapter - for example, in this particular chapter, we need a single package **HDSinRdata** \index{R packages!HDSinRdata} that contains the sample data sets used in this book.
