...
1.  Replicate the plot in @fig-q1, which shows the weekly Covid-19 cases by state in 2020 - the black vertical line signifies the week of May 28th, 2020, which is when US cases passed the 100,000 mark [@covid_timeline], and NA values are displayed as white squares). Hint: set negative weekly case counts to be NA and color the squares with a log 10 transformation.

  ![Covid-19 Cases Over Time by State.](images/7-exercise1plot.png){#fig-q1 fig-align="center" width="300pt"}

2.  Replicate the plot in @fig-q2, which is a stacked area chart for the total deaths from Covid-19 in the states with the top ten total death counts overall.

  ![Covid-19 Cases Over Time by State.](images/7-exercise2plot.png){#fig-q2 fig-align="center" width="300pt"}
