...
input_3 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/3_data_files.ipynb"
output_3_rmd <- rmarkdown:::convert_ipynb(input_3)
xfun::file_string(output_3_rmd)

input_4 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/4_exploratory_analysis.ipynb"
rmarkdown:::convert_ipynb(input_4, output = xfun::with_ext(input_4, "Rmd"))

input_5 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/5_data_transformations_summaries.ipynb"
rmarkdown:::convert_ipynb(input_5, output = xfun::with_ext(input_5, "Rmd"))

input_6 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/6_merging_data.ipynb"
rmarkdown:::convert_ipynb(input_6, output = xfun::with_ext(input_6, "Rmd"))

input_7 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/7_visualization_ggplot.ipynb"
rmarkdown:::convert_ipynb(input_7, output = xfun::with_ext(input_7, "Rmd"))

input_8 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/8_distributions.ipynb"
rmarkdown:::convert_ipynb(input_8, output = xfun::with_ext(input_8, "Rmd"))

input_9 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/9_hypothesis_tests.ipynb"
rmarkdown:::convert_ipynb(input_9, output = xfun::with_ext(input_9, "Rmd"))

input_10 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/10_linear_regression.ipynb"
rmarkdown:::convert_ipynb(input_10, output = xfun::with_ext(input_10, "Rmd"))

input_11 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/11_logistic_regression.ipynb"
rmarkdown:::convert_ipynb(input_11, output = xfun::with_ext(input_11, "Rmd"))

input_12 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/12_rmarkdown_reports.ipynb"
rmarkdown:::convert_ipynb(input_12, output = xfun::with_ext(input_12, "Rmd"))

input_13 <- "/Users/jialinliu/Documents/GitHub/r-for-health-data-science/book/13_expanding_r_skills.ipynb"
rmarkdown:::convert_ipynb(input_13, output = xfun::with_ext(input_13, "Rmd"))
```
