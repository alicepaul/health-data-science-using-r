...
To create a Quarto file, you will need to have RStudio installed as an application. For more recent versions of RStudio, Quarto will already be installed. If you have an older version, you can [install Quarto](https://quarto.org/docs/get-started/). We also recommend the **kableExtra** package [@R-kableExtra] for formatting your tables.
...
At the top of this pane is a toggle between source and visual mode. In visual mode, we can see that we have a text toolbar including options to bold text or add a list. If we switch to source mode, our text will reveal the underlying markdown in @fig-source-file and the toolbar will disappear. This chapter will focus on teaching you to edit in source mode, but you can always switch to visual mode if you prefer.
