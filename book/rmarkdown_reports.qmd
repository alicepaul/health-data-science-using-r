...
![](images/rmarkdown_reports/example-figure.png){fig-align="center" width="300pt"}
...
```
![](images/rmarkdown_reports/example-gt.png){fig-align="center" width="300pt"}
...
The exercise for this chapter is to recreate [this example pdf](https://github.com/alicepaul/health-data-science-using-r/blob/main/book/refs/ExampleRMarkdown.pdf) created from an R Markdown file. You will need to use the `breastcancer` dataset from the **HDSinRdata** package.
