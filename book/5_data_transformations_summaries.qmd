...
Filter the data to only those with an education level of more than HS who report alcohol use. Then, select only the diastolic blood pressure variables and display the 4th and 10th rows. Your result should match the result in @fig-5-pq1.

![Filtering and Selecting Data.](images/5-practicequestion1answer.png){#fig-5-pq1 fig-align="center" width="150pt"}
...
Create a data frame summarizing the percent of patients with hypertension by smoking status. The result should look like @fig-5-pq3.

  ![Grouping and Summarizing Data.](images/5-practicequestion3answer.png){#fig-5-pq3 fig-align="center" width="150pt"}
