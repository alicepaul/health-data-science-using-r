...
This chapter introduces you to linear regression analysis in R. We cover how to fit linear regression models, check model assumptions using diagnostic plots, change model formulas by adding transformations and interactions, calculate performance metrics, and perform variable selection using stepwise selection.
...
We use the **broom** package [@R-broom] to present the estimated coefficients for our regression models and the **car** package to compute variance inflation factors.
