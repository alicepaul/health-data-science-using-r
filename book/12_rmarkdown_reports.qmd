...
![Creating a New R Markdown Document.](images/12-new-r-markdown-window.png){#fig-new-markdown fig-align="center" width="300pt"}
...
![A New R Markdown Document.](images/12-r-markdown-file.png){#fig-rmarkdown-file fig-align="center" width="300pt"}

You will write all of the text and code that you would like to include in your report in this .Rmd file, and then you can produce a nicely formatted report from this file by 'knitting' the file. You can either knit to HTML, PDF, or WORD by clicking on the knit icon ![](images/12-knit-icon.png){width=30pt} from the toolbar at the top of the page and then selecting your desired output file type.
...
-   click on this green "add chunk" symbol ![](images/12-add-chunk.png){width=25pt} in the toolbar at the top of the page, 

-   type ```` ```{r} ```` and ```` ``` ````, OR

-   use the keyboard shortcut **Ctrl + Alt + I** (**Cmd + Option + I** on Macs).

To run the code in a chunk, you can either use the keyboard shortcut **Ctrl + Enter** (**Cmd + Return** on Mac), or you can use one of the following buttons at the top right of the chunks: ![](images/12-run-all-chunks-above.png){width=20pt} runs all chunks above the current chunk and ![](images/12-run-current-chunk.png){width=20pt} runs the current chunk.
...
![Example header sizes.](images/12-headers.png){#fig-headers fig-align="center" width="200pt"}
...
![](images/12-example-figure.png){fig-align="center" width="300pt"}
...
```
![](images/12-example-gt.png){fig-align="center" width="300pt"}
...
The exercise for this chapter is to recreate [this example pdf](https://github.com/alicepaul/health-data-science-using-r/blob/main/book/docs/ExampleRMarkdown.pdf) created from an R Markdown file. You will need to use the `breastcancer` dataset from the **HDSinRdata** package.
