...
We will use the **broom** package again to present the estimated coefficients, the **tidyverse** package to create a calibration plots, the **lmtest** [@R-lmtest] package to perform likelihood ratio tests, and the **pROC** package [@R-pROC] to create receiver operating characteristic curves.
...
Create a calibration plot with 5 cuts for your model from the previous practice question (recall that this model should have cigarette use as the outcome and age, race_and_ethnicity, LGBT, and family_affluence as well as an interaction between family_affluence and race_and_ethnicity as independent variables). It should look like @fig-11-pq2.

![Calibration Plot.](images/11-practicequestion2answer.png){#fig-11-pq2 fig-align="center" width="300pt"}
