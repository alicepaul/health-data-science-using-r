...
Recreate the barplot in @fig-4-pq1 showing the proportion of values in each `LEAD_QUANTILE` category.

![Lead Quantile Bar Plot.](images/4-practicequestion1answer.png){#fig-4-pq1 fig-align="center" width="70%"}
...
Recreate the three boxplots in @fig-4-pq2 (one for each education level) of income by BMI category and arrange them next to each other using the par() function.

![Box Plot Example.](images/4-practicequestion2answer.png){#fig-4-pq2 fig-align="center" width="100%"}
...
![Education Levels Over Time.](images/4-exercise4plot1.png){#fig-q41 fig-align="center" width="80%"}

![Blood Lead Level by Education Level.](images/4-exercise4plot2.png){#fig-q42 fig-align="center" width="80%"}
